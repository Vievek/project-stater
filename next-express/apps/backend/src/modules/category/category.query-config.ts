...
//   category.query-config.extended.ts

export const categoryQueryConfig: QueryFieldConfig = {
  sortableFields: ['id', 'name', 'createdAt', 'updatedAt'],
  filterableFields: ['id', 'name', 'createdAt', 'updatedAt'],
  searchableFields: ['id', 'name'],
};

export const CategoryFilterableFieldsEnum = z.enum(['id', 'name', 'createdAt', 'updatedAt']);
export const CategorySortableFieldsEnum = z.enum(['id', 'name', 'createdAt', 'updatedAt']);

export const categoryQuerySchema = z.object({
  search: z.string().optional(),
  sort: z.array(
    z.object({
      field: CategorySortableFieldsEnum,
      direction: z.enum(['asc', 'desc']),
    })
  ).optional(),
  filters: z.array(
    z.object({
      field: CategoryFilterableFieldsEnum,
